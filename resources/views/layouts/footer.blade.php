<div id="footer" class="py-3 text-center text-sm w-full bg-[#626262] text-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="">
      <div class="flex justify-center "> <x-application-logo class="w-auto h-12" /></div>
      <ul
      ...
      <div class="grid grid-cols-5 gap-3 max-w-3xl mx-auto py-5">
        ...
        <x-logo-a-footer href="https://edu.gov.ru/" lname="pravdpr.png" alt="Правительство ДНР"/>
