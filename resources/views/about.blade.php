...
<body class="font-sans antialiased dark:bg-black dark:text-white/50 class=" min-w-[340px]"">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <!-- <img id="background" class="absolute -left-20 top-0 max-w-[877px] z-40" src="https://laravel.com/assets/img/welcome/background.svg" alt="Laravel background" /> -->
        @include('layouts.left-hidded-menu')
        <div class="bg-gray-200 shadow h-40 md:h-44 w-full">
            <div style="line-height: 48px;">РЕГИОНАЛЬНЫЙ ЦЕНТР ОБРАБОТКИ ИНФОРМАЦИИ</div>
