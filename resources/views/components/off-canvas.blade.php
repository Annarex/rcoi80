...
<div class="relative top-0 left-0 right-0 bg-blue-300 shadow h-40 md:h-36 w-full"></div>
<div id="header" class="fixed top-0 left-0 right-0 flex flex-wrap items-center justify-between p-1 z-10 bg-transparent transition-all duration-150 ease-in-out"> <!--transition-all duration-300 ease-in-out bg-transparent -->
    ...
    <div class="flex-grow flex justify-center h-14 md:h-16 lg:h-32 ">
        <x-application-logo class="w-auto" /><!--  -->
    </div>
    <div class="flex-shrink-0 justify-center" >
      <p class="text-white whitespace-nowrap">Адрес 283001, ДНР, Г.О. Донецкий,<br>г. Донецк, ул. Артема, 129А<br>Тел +7(856)-305-18-86<br>Е-mail: rtsoi.donriro@yandex.ru</p>
    </div>

</div>
<div class="bg-blue-300 shadow h-40 md:h-44 w-full"></div>
<!-- drawer component -->
  ...
  <div class="py-4 overflow-y-auto">
    ...
    <script>
        window.addEventListener('scroll', function() {
            ...
            if (window.scrollY === 0) {
                header.classList.remove('bg-gray-900','bg-opacity-20','h-36', 'shadow-none');
                header.classList.add('bg-transparent', 'h-36');
            } else {
                header.classList.remove('bg-transparent', 'h-36', 'shadow-none');
                header.classList.add('bg-gray-900','bg-opacity-20', 'h-36', 'shadow-lg');
            }
        });
    </script>